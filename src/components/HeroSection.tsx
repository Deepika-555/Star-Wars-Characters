  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-0">
        <span className="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-primary/90 shadow-[0_0_25px_rgba(247,223,80,0.15)]">
          A Galaxy of Stories
        </span>

        <h1 className="mt-6 text-4xl font-bold leading-tight text-balance sm:text-5xl md:text-6xl lg:text-7xl">
          <span className="text-foreground">Explore the</span>{' '}
          <span className="bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent drop-shadow-[0_10px_40px_rgba(247,223,80,0.35)]">
            Star Wars Galaxy
          </span>
        </h1>
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-center">
          <Input
            ...
            className="h-12 flex-1 min-w-0 border border-primary/40 bg-background/70 text-base shadow-[0_10px_35px_rgba(11,18,35,0.65)] backdrop-blur placeholder:text-muted-foreground/70 focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/30"
          />
          <Button
            onClick={onSearch}
            className="h-12 w-full bg-primary text-primary-foreground shadow-[0_10px_40px_rgba(247,223,80,0.35)] transition-all hover:-translate-y-0.5 hover:bg-primary/90 sm:w-auto"
          >
            Search
          </Button>
        </div>
      ...
      <div
        id="filters"
        className="relative mx-auto mt-14 max-w-4xl rounded-2xl border border-white/10 bg-white/5 p-6 shadow-[0_30px_80px_rgba(5,10,20,0.65)] backdrop-blur-sm sm:p-8"
      >
